...
export default function Advisor() {
  ...
  // Delete failures were previously dropped: handleDelete had no catch and
  // was invoked as `void handleDelete(...)`, so a rejection became an
  // unhandled promise rejection and the row just sat there. Mirrors the
  // banner on the CRM tab.
    ...
    try {
      ...
      setDeleteError(
        err instanceof Error
          ? err.message
          : `Could not delete ${investment.ticker}.`,
      );
    } finally {
