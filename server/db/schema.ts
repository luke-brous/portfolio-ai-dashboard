...
export const reports = sqliteTable('reports', {
    ...
    nonprofitId: integer('nonprofit_id').references(() => nonprofits.id).notNull(),
...
export const newsItems = sqliteTable('news_items', {
  ...
  finnhubInvestmentIdx: uniqueIndex('news_finnhub_investment_idx')
    .on(t.finnhubId, t.investmentId),
}));
